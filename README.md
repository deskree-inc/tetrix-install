...
This tree's `VERSION` is **0.8.67** (Cloud guest: retry Docker→GCE metadata probe after compose
pull). First-party `sha-` pins stay at chart 0.8.56. The Helm
OCI chart remains **0.8.54** (latest published chart). A public `v0.8.67`
